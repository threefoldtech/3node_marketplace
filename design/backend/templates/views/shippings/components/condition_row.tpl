                ...
                {if $allow_save}
                    <div class="btn-group shipping-rate_{literal}${data.index}{/literal}_per-unit">
                        ...
                        <ul class="dropdown-menu shipping-rate__input-append-list">
                            ...
                            >
                                <a class="cm-check-items cm-on" data-ca-target="percentage-{literal}${data.type}{/literal}-{literal}${data.destinationId}{/literal}-{literal}${data.index}{/literal}">{__("shipping_rate_percentage")}</a>
                            </li>
                            {literal}
